  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <KPICard title="Total Revenue" value={`${(kpiData.totalRevenue.value / 1000000).toFixed(2)}M`} unit="LKR" trend={kpiData.totalRevenue.trend} trending={kpiData.totalRevenue.trending} icon={<DollarSign className="text-purple-600" />} color="purple" />
