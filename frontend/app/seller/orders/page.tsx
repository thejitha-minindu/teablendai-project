  ...
  return (
    <div className="space-y-8 sm:px-4 lg:px-10 lg:pt-10 mb-10">
      ...
      <div className="mb-5 items-start">
        ...
        <p className="text-muted-foreground mt-2">Manage and track all your buyer orders</p>
      </div>
                ...
                {isExpanded && (
                  <div className="border-t border-gray-100 px-5 pb-5 pt-4 bg-gray-50/50">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      {/* Buyer Info */}
                      <div className="space-y-2">
                        <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Buyer Info</h4>
                        <div className="space-y-1.5 text-sm">
                      ...
                      <div className="space-y-3">
                        ...
                        {nextStatus && isPaid && (
                          <button
                            ...
                            disabled={isUpdating}
                            className="w-full bg-white text-gray-700 border border-gray-200 px-4 py-2.5 rounded-xl font-semibold text-sm hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                          >
                            {isUpdating ? (
                        ...
                        {!nextStatus && order.order_status === "delivered" && (
                          <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 text-center">
                            <p className="text-xs font-semibold text-gray-700">✅ Order Delivered Successfully</p>
                          </div>
                        )}
